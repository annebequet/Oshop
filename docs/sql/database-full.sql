...
CREATE TABLE `brand` (
  ...
  `name` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Le nom de la marque',
...
(1,	'oCirage',	1,	'2018-10-17 07:00:00',	NULL),
(2,	'BOOTstrap',	3,	'2018-10-17 07:00:00',	NULL),
(3,	'Talonette',	4,	'2018-10-17 07:00:00',	NULL),
(4,	'Shossures',	2,	'2018-10-17 07:00:00',	NULL),
(5,	'O\'shoes',	0,	'2018-10-17 07:00:00',	NULL),
(6,	'Pattes d\'eph',	0,	'2018-10-17 07:00:00',	NULL),
(7,	'PHPieds',	5,	'2018-10-17 07:00:00',	NULL),
(8,	'oPompes',	0,	'2018-10-17 07:00:00',	NULL);

DROP TABLE IF EXISTS `category`;
CREATE TABLE `category` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Le nom de la catégorie',
  `subtitle` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `picture` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'L''URL de l''image de la catégorie (utilisée en home, par exemple)',
...
(1,	'Détente',	'Se faire plaisir',	'https://benoclock.github.io/S06-images/categ1.jpeg',	4,	'2018-10-17 06:00:00',	NULL),
(2,	'Au travail',	'C\'est parti',	'https://benoclock.github.io/S06-images/categ2.jpeg',	2,	'2018-10-17 06:00:00',	NULL),
(3,	'Cérémonie',	'Bien choisir',	'https://benoclock.github.io/S06-images/categ3.jpeg',	5,	'2018-10-17 06:00:00',	NULL),
(4,	'Sortir',	'Faire un tour',	'https://benoclock.github.io/S06-images/categ4.jpeg',	3,	'2018-10-17 06:00:00',	NULL),
(5,	'Vintage',	'Découvrir',	'https://benoclock.github.io/S06-images/categ5.jpeg',	1,	'2018-10-17 06:00:00',	NULL),
...
CREATE TABLE `product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Le nom du produit',
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'La description du produit',
  `picture` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'L''URL de l''image du produit',
...
(1,	'Kissing',	'Proinde concepta rabie saeviore, quam desperatio incendebat et fames, amplificatis viribus ardore incohibili in excidium urbium matris Seleuciae efferebantur, quam comes tuebatur Castricius tresque legiones bellicis sudoribus induratae.',	'https://benoclock.github.io/S06-images/produits/1-kiss.jpg',	40.00,	4,	1,	'2018-10-17 09:00:00',	NULL,	2,	1,	7),
...
CREATE TABLE `type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Le nom du type',
...
(1,	'Chaussures de ville',	1,	'2018-10-17 08:00:00',	NULL),
(2,	'Chaussures de sport',	2,	'2018-10-17 08:00:00',	NULL),
(3,	'Tongs',	4,	'2018-10-17 08:00:00',	NULL),
(4,	'Chaussures ouvertes',	0,	'2018-10-17 08:00:00',	NULL),
(5,	'Talons éguilles',	0,	'2018-10-17 08:00:00',	NULL),
(6,	'Talons',	0,	'2018-10-17 08:00:00',	NULL),
(7,	'Pantoufles',	3,	'2018-10-17 08:00:00',	NULL),
(8,	'Chaussons',	5,	'2018-10-17 08:00:00',	NULL);
